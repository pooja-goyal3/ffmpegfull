...
public class FfmpegAudioActivity extends Activity implements View.OnClickListener, PermissionListener {
        ...
        switch (view.getId()) {
            case R.id.run_command:
                ...
                try {
                    ...
                    ffmpegAudio(urlString, outfile, s -> addTextViewToLayout(s));
                }
                catch (Exception e) {
